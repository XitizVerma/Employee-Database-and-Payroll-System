...
//        setUndecorated(true);
        ...
        System.out.println(ClassLoader.getSystemResource("payroll_project/icons/login2.png"));
       // ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("payroll_project/icons/login2.png"));
        ImageIcon img=new ImageIcon(this.getClass().getResource("icons/login2.png"));
